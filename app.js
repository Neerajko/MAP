...
function initMap() {
    ...
    // var tribeca={lat: 11.942836, lng: 75.349963};
    ...
    // 		content:'hefkledfjklndkldnjlnedjnjlfnl'
    // 	});
    ...
    //Create a "highlighted location" marker color when the user's mouse over the marker
    var highlightedIcon = makeMarkerIcon('ffff24');


    //the following gorup uses the location array to create an array of markers on initialize
    for (var i = 0; i < locations.length; i++) {
        //Get position from locations array
    ...
    drawingManager.addListener('overlaycomplete', function() {
        ...
        window.alert(area + "SquareMeteres");
    });
}
...
//we will only allow one infowindow when one marker is clicked and populate based on that markers position
